        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentCVV = table.Column<string>(type: "nvarchar(18)", maxLength: 18, nullable: false),
                    PaymentCardHolderName = table.Column<string>(type: "nvarchar(18)", maxLength: 18, nullable: false),
                    PaymentCardName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PaymentCardNumber = table.Column<string>(type: "nvarchar(max)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
